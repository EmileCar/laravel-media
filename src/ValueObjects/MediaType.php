...
enum MediaType: string
{
    ...
    /**
     * Check if this media type supports auto-generated thumbnails
     * Only images can have thumbnails auto-generated from the source file
     * All other types can still have thumbnails via URL/file/path
     */
    public function supportsAutoGeneratedThumbnails(): bool
    {
     ...
     * Alias for supportsAutoGeneratedThumbnails for backwards compatibility
     */
    public function supportsThumbnails(): bool
    {
        return $this->supportsAutoGeneratedThumbnails();
    }
