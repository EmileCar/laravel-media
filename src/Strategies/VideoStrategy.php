...
class VideoStrategy implements MediaUploadStrategyInterface, MediaRetrievalStrategyInterface
{
    ...
    {
        $allowedMimes = ['video/mp4', 'video/quicktime', 'video/x-msvideo', 'video/mpeg'];
    ...
    public function getMedia(MediaResource $media): BinaryFileResponse
    {
        ...
        $mimeType = MediaUtilities::getMimeType($media->file_name, 'video/mp4');
    ...
    {
        // Videos don't support thumbnails in this implementation
        return null;
    }
